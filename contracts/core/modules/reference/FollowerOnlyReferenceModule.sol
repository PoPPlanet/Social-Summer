...
contract FollowerOnlyReferenceModule is FollowValidationModuleBase, IReferenceModule {
    ...
    function processComment(
        ...
        _checkFollow(profileId, profileIdPointed);
    }
    ...
    function _checkFollow(uint256 profileId, uint256 profileIdPointed) internal view{
        if (!IPoPPHub(HUB).isFollowing(profileId, profileIdPointed)){
