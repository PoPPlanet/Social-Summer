...
interface IPoPPHub {
    ...
    function initialize(
        ...
        address newTeamAwardAddress, address _summerAwardAddress, address _summerAwardNightAddress
    ) external;
     ...
     */
    function createAccount(DataTypes.CreateProfileData calldata vars) external payable returns (uint256);
    function batchCreateAccount(DataTypes.CreateProfileData[] calldata vars) external payable;
    /**
    ...
    function setProfileHandle(uint256 profileId, string calldata handle) external;
