...
library Events {
    ...
    event ProfileHandleSet(uint256 indexed profileId, string handle, uint256 timestamp);
    ...
    event LuckNumber(uint256 level, uint256 round, uint256 times, uint256 start, uint256 end, uint256 luckNumber);
    event LuckBlack(uint256 round, uint256 start, uint256 end, uint256 luckNumber);
}
