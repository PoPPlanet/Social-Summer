...
library ProfileTokenURILogic {
            ...
            abi.encodePacked(
                ...
                Base64.encode(
                    abi.encodePacked(
                        ...
                        '","description":"',
                            handle,
                        ' - PoPP profile","image":"data:image/svg+xml;base64,',
                        getSVGImageBase64Encoded(handle, imageURI),
     ...
     */
    function getSVGImageBase64Encoded(string memory handleWithAtSymbol, string memory imageURI)
    public
    pure
